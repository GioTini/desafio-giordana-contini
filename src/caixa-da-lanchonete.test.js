...
describe('CaixaDaLanchonete', () => {
    ...
    const possuiResultadoEsperado = (formaDePagamento, resultadoEsperado, itens) => {
    ...
    test.each([
        ...
        possuiResultadoEsperado(formaDePagamento, resultadoEsperado, itens));

    test.each([
        ['dinheiro', 'R$ 2,85', ['cafe,1']],
        ['credito', 'R$ 3,09', ['cafe,1']],
        ['debito', 'R$ 3,00', ['cafe,1']],
    ])('compra simples em %p deve resultar em %p', possuiResultadoEsperado);

    test.each([
        ['credito', 'R$ 11,85', ['cafe,1', 'sanduiche,1', 'queijo,1']],
        ['debito', 'R$ 11,50', ['cafe,1', 'sanduiche,1', 'queijo,1']],
    ])('compra de 3 itens em %p deve resultar em %p', possuiResultadoEsperado);
    ...
    ])('compra de múltiplas quantidades em %p deve resultar em %p', possuiResultadoEsperado);
